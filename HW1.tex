...
$\AdvPRF{F}{B} $\\
$=2\left[\frac{1}{2}(P_r(\ExpGuess{F,\tau}{A} =1) + \left[1 -
\frac{1}{{{(2^\tau)}^2}^n}\right]  \right]- 1
= 
\left P_r[\ExpGuess{F,\tau}{A}=1] - \frac{1}{{{(2^\tau)}^2}^m}}
$

Hence, $\AdvGuess{F,\tau}{A} \leq \AdvPRF{F}{B}+\left[\frac{1}{{{(2^\tau)}^2}^n}\right]
$
